...
public class LevelMakerEditor : EditorWindow
{
    ...
    void GUIShowWarning()
    {
        ...
        GUILayout.Label("Please open scene - game ( Assets/CakeLand/Scenes/game.unity )", EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width(600) });
    ...
    void GUILevelSelector()
    {
        ...
        GUILayout.Label("Assets/CakeLand/Resouces/Levels/", EditorStyles.label, new GUILayoutOption[] { GUILayout.Width(200) });
        GUILayout.EndHorizontal();
        GUILayout.EndVertical();
