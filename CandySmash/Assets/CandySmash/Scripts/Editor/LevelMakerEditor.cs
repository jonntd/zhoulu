...
public class LevelMakerEditor : EditorWindow
{
    ...
    void GUIShowWarning()
    {
        ...
        GUILayout.Label("Please open scene - game ( Assets/CandySmash/Scenes/game.unity )", EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width(600) });
    ...
    void GUILevelSelector()
    {
        ...
        GUILayout.Label("Assets/CandySmash/Resouces/Levels/", EditorStyles.label, new GUILayoutOption[] { GUILayout.Width(200) });
        GUILayout.EndHorizontal();
        GUILayout.EndVertical();
    ...
    public void SaveMap(string fileName)
    {
        ...
        {
            //Write to file
            string activeDir = Application.dataPath + @"/CandySmash/Resources/Levels/";
