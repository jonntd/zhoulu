...
public class NotificationConfig
{
    ...
    public static string next_day_text = "Come back to PopGarden and enjoy the fun time!";

    //3日后发送 259200
    public static int day3_time = 259200;
    public static string day3_text = "Come back to PopGarden and enjoy the fun time!";

    //7日后发送 604800
    public static int day7_time = 604800;
    public static string day7_text = "Come back to PopGarden and enjoy the fun time!";
